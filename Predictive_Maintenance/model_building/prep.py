from huggingface_hub import HfApi import os import pandas as pd from sklearn.model_selection import train_test_split
...
PATHS
==========================================
save_path = os.path.join( os.getcwd(), "Predictive_Maintenance", "data" )

os.makedirs( save_path, exist_ok=True )

dataset_path = os.path.join( save_path, "engine_data.csv" )

print("Dataset Path:", dataset_path) print("Dataset Exists:", os.path.exists(dataset_path))
...
print("Dataset Loaded Successfully") print("Shape:", df.shape)
...
print("Train Shape:", train_df.shape) print("Test Shape:", test_df.shape)
...
print("Train CSV Saved") print("Test CSV Saved")
